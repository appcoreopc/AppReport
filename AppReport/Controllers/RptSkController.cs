    ...
    { 
        ...
        private void print(RptSk rptSk, IEnumerable<RptSkMimp> rptSkMimp)
        {
            ...
            { 
                ...
                doc.AddAuthor("PTS");
                doc.AddCreator("PTS");
                doc.AddKeywords("PTS SKIM KHAS");
                doc.AddSubject("PTS SKIM KHAS");
...
Website: {rptSk.FCoWebsite}", f2));
                    ...
                    cell = new PdfPCell(new Phrase(letterDate, f4));
                    cell.HorizontalAlignment = Element.ALIGN_LEFT;
                    cell.Border = PdfCell.NO_BORDER;
                    t2.AddCell(cell);
                    ...
                    cell = new PdfPCell(new Phrase("LAMPIRAN B", f8));
